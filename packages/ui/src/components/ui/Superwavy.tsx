...
export function Superwavy() {
  ...
  return (
    <div className="w-[900px] h-[200px] grid grid-cols-3 grid-rows-2 gap-1 bg-slate-900 p-1">
      ...
      {!isSettingsMode ? (
        <>
          ...
          <button
            onClick={() => toggleFilter("underrated")}
          ...
          <button
            onClick={() => toggleFilter("twitter-ogs")}
        ...
        <>
          ...
          <SettingTile description="Filter model type">
            <ModelSelect value={modelType} onChange={setModelType} />
          </SettingTile>
